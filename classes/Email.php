...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido = "<html>";
        $contenido .= "<p>¡Hola<strong> " . $this->nombre . "</strong>! Has creado tu cuenta en AppSalon, solo debes confirmar presionando el siguiente enlace.</p>";
    ...
    public function enviarInstrucciones()
    {
        ...
        $contenido .= "<p>Presiona aquí: <a href='http://localhost:3000/recover-password?token=" . $this->token . "'>Reestablecer contraseña</a></p>";
        $contenido .= "<p>Si tu no solicitaste esta cuenta, puedes ignorar el mensaje.</p>";
        $contenido .= "</html>";
